...
const GithubCorner = () => (
  <a href="https://unruffled-mccarthy-d11a25.netlify.com/" className="github-corner" aria-label="View source on Github">
    <svg width="60" height="60" viewBox="0 0 250 250" aria-hidden="true" fill="#ffaaa5" className="github-corner-svg">
